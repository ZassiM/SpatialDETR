...
from App.SyncedConfigs import SyncedLists
...
class App(UI):
    ...
    def visualize(self):
        ...
        if self.selected_expl_type.get() != self.old_expl_type or self.raw_attn.get() != self.old_raw or self.selected_head_fusion.get() != self.old_head_fusion or self.selected_discard_ratio.get() != self.old_discard_ratio or self.handle_residual != self.old_handle_residuel or self.apply_rule != self.old_apply_rule:
